...
"""
Author: Marcos Duarte, University of Sao Paulo, Brazil (http://lob.iv.fapesp.br/)
...
def DLTcalib(nd, xyz, uv):
    ...
    # Mean error of thesdz DLT (mean residual of the DLT transformation in units of camera coordinates):
